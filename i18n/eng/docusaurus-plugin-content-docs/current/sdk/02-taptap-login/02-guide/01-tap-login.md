...
1. Reference the above guide on [Initialization](#Initialization) and [Using TapTap OAuth Results for Account Login](#Use -taptap-oauth- Results for Account Login) to complete TapTap Login for TDS Authentication to obtain a TDSUser login.
