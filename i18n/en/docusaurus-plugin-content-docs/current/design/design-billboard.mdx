...
### Horizontal screen configuration cut size

Custom horizontal announcement system need to upload top navigation bar background, left tab bar card background and pop-up window background image cutout, cutout are triple image @3X size, file type: JPG. PNG.

<Background>
  <Figure
    caption="Example of the composition and cutout of the pop-up window of the horizontal announcement system"
    imgSrc={useBaseUrl("/img/design-billboard/2.1.png")}
    imgAlt=""
  />
</Background>

### Customization suggestions for horizontal screen configurations
...
### Vertical screen configuration cut size
Custom vertical announcement system need to upload the top navigation bar background, tab bar card background, pop-up window background image and back to previous level button cutout, cutout are triple image @3X size, file type: JPG. PNG.  

<Background>
  <Figure
    caption="Example of pop-up window composition and cutout for vertical announcement system"
    imgSrc={useBaseUrl("/img/design-billboard/2.4.png")}
    imgAlt=""
  />
</Background>

### Customization suggestions for vertical screen configuration
