...
This article will show you how to use push notifications in your Unity project. We recommend that you take a look at [Push Notification Overview](/shadow/push/guide/overview/) if you haven’t already.
...
Please first obtain an iOS push notification certificate by following [APNs Configuration Guide](/shadow/push/guide/ios-cert/).

### Android

Please first apply for push notification permissions from <Conditional region="cn">Android vendors</Conditional><Conditional region="global">FCM</Conditional> by following [Android Mixpush Guide](/shadow/push/guide/android-mixpush/).
...
For more information about the message format, see [Push Notification REST API Guide](/shadow/push/guide/rest#推送消息). For Android devices, the default message content parameter contains the following properties:
