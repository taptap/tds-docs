...
Before continuing, make sure you have [finished initializing the SDK](/shadow/friends/guide/).
...
There are some [REST API interfaces](/shadow/friends/guide/#rich-presence-rest-api) related to rich presence.
...
A player can follow other players by entering their [friend codes](/shadow/friends/mutual/#friend-code).
