...
- [Friend mode](/shadow/friends/mutual/)
- [Follow mode](/shadow/friends/follow/)
...
Your game can also obtain players’ connections [from third-party platforms](/shadow/friends/third-party/). To use this feature, please submit a ticket to us to enable it.
