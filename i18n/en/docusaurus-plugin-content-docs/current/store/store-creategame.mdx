...
Attention:  
1\. For details about the materials to provide, see [Material Requirements](http://www.taptap.cn/developer/help_docs/7?id=42).    
2\. You may fill in the <Blue>Basic Information</Blue>, <Blue>Game Info</Blue> in <Blue>Apply for Release</Blue> according to your own needs. You can also refer to  [Best Practices](https://www.taptap.cn/developer-center/doc/7?id=89) for tips on optimizing your game.
...
After the new game is submitted for audit, the result is expected to be available within 2 business days. You will be informed of the result in [Notifications](https://www.taptap.cn/notifications?type=4&show_type=inbox), or you can check Developer Center. Please be available for contact during the audit as TapTap operations staff may reach you for more information.     
