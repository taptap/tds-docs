...
- When the player performs an action that unlocks one or more achievements, a notification will appear at the top area of the screen. Only one achievement can be displayed at a time. Additional achievements will be queued and displayed one at a time.
- You can choose whether to show or hide the achievements page and the notifications.
...
- If your game already tracks the achievements your players have earned, you can convert those achievements to the appropriate Achievement IDs and submit them all at once with the SDK when it’s convenient (you may want to temporarily turn off notifications so the players don’t see them).
