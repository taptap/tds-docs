...
Before integrating TDS into your game, please first create an application. See [Store Guide](/store/store-creategame/) for more details.
...
To integrate Account Services into your game, you must first agree to the [TapTap Platform Developers Agreement](/store/). By using TDS, you agree to the above agreement. You will hereby bear the corresponding legal liabilities and obligations as per this agreement.
