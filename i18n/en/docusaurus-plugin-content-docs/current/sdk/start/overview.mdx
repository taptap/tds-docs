...
- **[TapTap Connect](/sdk/taptap-connect/features/)**: Provides a tool to connect TapTap, games and players. Players who have successfully signed in to their TapTap accounts can browse game news, rate games, share game download links and more in the hover window to help games improve retention and attract new users.
...
- **[TapLink](/sdk/taplink/features/)**: Help player jump from TapTap to the game to collect the gift packs.
...
- **[Customer Support](/sdk/tap-support/features/)**: Access to Tap Game Customer Service helps the game operation team to solve problem encountered by player faster and better.
