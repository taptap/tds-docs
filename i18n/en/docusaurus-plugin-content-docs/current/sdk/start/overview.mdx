...
- **[TapTap Connect](/sdk/taptap-connect/features/)**: Provides a tool to connect TapTap, game and player. Player who have successfully signed in to their TapTap accounts can browse game news, rate games, share game download links and more in the hover window to help games improve retention and attract new user.
