...
![Register with APNs and obtain a token](/img/apns-registration.svg)

Then you can invoke the interface provided by the Push Notification service to send a push notification:

![Invoke the interface provided by the Push Notification service to send a push notification](/img/push-workflow-ios.svg)
