...
Please also see [Data Storage REST API](/sdk/storage/guide/rest/) for more information about API Base URL, request format, and response format, as well as the _Custom Word List_ section in [Full-Text Search Guide](/sdk/storage/guide/fulltext-search/).
