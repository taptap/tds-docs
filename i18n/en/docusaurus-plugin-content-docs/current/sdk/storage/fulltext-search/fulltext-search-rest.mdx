...
Please also see [Data Storage REST API](/sdk/storage/guide/rest/) for more information about API Base URL, request format, and response format, as well as the _[Custom Word List](/sdk/storage/guide/fulltext-search/#custom-word-list)_ section in _Full-Text Search Guide_.
