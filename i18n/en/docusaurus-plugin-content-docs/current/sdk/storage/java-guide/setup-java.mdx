...
<application
  ...
  <!-- Instant Messaging and Push Notifications START -->
  <!-- Both Instant Messaging and Push Notifications require PushService -->
  ...
  <!-- Instant Messaging and Push Notifications END -->
</application>
```

Note: If you’re using Instant Messaging without Push Notifications, you can set the `LCIMOptions#disableAutoLogin4Push` when initializing the SDK so that it will take less time for the users to log in:

```java
// Call after LeanCloud#initialize to disable the automatic login request for Push Notifications
