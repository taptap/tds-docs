...
Go to TapTap Developer Center and fill in the application information according to [Material Requirements](/store/release/store-material/), then wait for the review.
