...
Please [download](/tap-download) the SDK and add the following dependencies to your game:

<MultiLang>

<>

Import the SDK **either manually or with the Unity Package Manager**.

1. You can manually import the SDK.
2. If you choose to use the UPM, you can add the following lines to the `Packages/manifest.json` of your game project:
...
If everything worked out well, you may <Conditional region="cn">[release your game](/store/store-release/)</Conditional><Conditional region="global">[release your game](/store/store-publish-game/)</Conditional>.
