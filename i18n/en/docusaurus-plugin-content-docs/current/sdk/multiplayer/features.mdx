---
title: Multiplayer online battle function introduction
...
- [Multiplayer Online Battle Development Guide JavaScript](/sdk/multiplayer/guide/js/)
- [Multiplayer Online Battle Development Guide · C#](/sdk/multiplayer/guide/cs/)
...
- **MasterClient**: Multiplayer online battles use [MasterClient](/sdk/multiplayer/guide/js/#masterclient) as the computing host on the client side, and the MasterClient controls the game logic, such as determining whether the game is starting or ending, downloading Who will operate the round, how many gold coins will be deducted from the player, and so on.
...
- [Quick Start](/sdk/multiplayer/start/js/): Quickly access multiplayer online battles and run a small demo
- [Multiplayer Online Battle Development Guide · JavaScript](/sdk/multiplayer/guide/js/): A detailed introduction to all the functions and interfaces of Multiplayer Online Battle.

### C#

- [Quick Start](/sdk/multiplayer/start/cs/): Quickly access multiplayer online battles and run a small demo
- [Multiplayer Online Battle Development Guide·C#](/sdk/multiplayer/guide/cs/): A detailed introduction to all the functions and interfaces of Multiplayer Online Battle.