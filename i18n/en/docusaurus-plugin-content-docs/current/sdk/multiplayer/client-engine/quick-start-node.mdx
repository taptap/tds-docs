...
This document helps you get up to speed on how to create a Client Engine project, a simple two-player rock-paper-scissors game that relies on the multiplayer online battles JavaScript SDK for its logic.
