...
The system will charge according to the daily peak consumption of computing units, the price of a single computing unit can be found on the [official website](https://developer.taptap.io/product-intro/price). For example, if an application on a domestic node uses up to 2 computing units on a given day, the charge for that day will be 2 * domestic computing unit price.

</Conditional>

<Conditional region="cn">

The system will charge according to the daily peak consumption of computing units, the price of a single computing unit can be found on the [official website](https://developer.taptap.cn/product-intro/price). For example, if an application on a domestic node uses up to 2 computing units on a given day, the charge for that day will be 2 * domestic computing unit price.
