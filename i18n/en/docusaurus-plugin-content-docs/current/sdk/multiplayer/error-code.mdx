---
title: Multiplayer Online Battle Error Code Details
sidebar_label: Error Code Details
sidebar_position: 5
---
...
- Meaning - The account to which the application belongs is not paid, please recharge the account before using the application.

<!--
It's not live yet.
### 4003
* Message - GAME_SERVICE_DISABLED_ON_APP
* Meaning - The application is disabled for gaming. -->
...
- Meaning - Room could not be found, the following conditions will cause this error:
  ...
  - Room name was specified to be added to the room, but the room has been destroyed or has an incorrect name.
...
- Meaning - Room already exists, create a room with another Room name.

### 4312

- Message - ROOM_ATTRS_FULL
- Meaning - The attribute of Room has reached the maximum length limit.
...
- Meaning - An error occurs when a user joins another room without leaving the current room, please call the leave method first before joining another room.
...
- Meaning - On a link that already has a user logged in, another login request is received from another user.
...
- Meaning - Wrong parameter, please check the detail information.
