...
If your app allows users to create group chats, you might consider filtering cuss words from the messages sent by users. Instant Messaging offers a built-in component that helps you easily implement this function. See [Keyword Filtering](/sdk/im/guide/senior/) in the next chapter for more details.

</Conditional>

<Conditional region="global">

See [Keyword Filtering](/sdk/im/guide/senior/) in the next chapter for more details.
...
If a user hasn't been online for an extremely long time, there will be tons of messages piled up on the cloud. How can we make sure that all these messages will be perfectly delivered once the user goes online?
