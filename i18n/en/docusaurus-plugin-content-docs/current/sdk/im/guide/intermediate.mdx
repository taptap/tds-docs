...
There are two ways for synchronizing messages:
...
> Please don't use different methods for different platforms at the same time (for example, use the first method for iOS and the second for Android). This will make your app unable to fetch messages correctly.
