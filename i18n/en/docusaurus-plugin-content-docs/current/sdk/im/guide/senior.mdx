...
// A Cloud Engine-based signature factory for signing requests for blacklist operations
...
> Java, Android SDKs offer `LCIMClient#getChatRoomQuery` methods that are dedicated to querying chat rooms. By using it, you won't need to deal with the `transient` attribute of conversations.
