...
To start using TDS’ Real-Name Verification and Anti-addiction service, please first enable it for your game under **游戏服务 > 生态服务 > 合规认证**.

![](/img/anti-addiction/compliance-certification.png)
...
Please fill these credentials into the Developer Center:
...
You can select whether to enable TapTap Quick Verification when [invoking the SDK’s interface](/sdk/anti-addiction/guide/#防沉迷授权).
