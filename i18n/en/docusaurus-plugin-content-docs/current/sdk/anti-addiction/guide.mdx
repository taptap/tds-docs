...
You can enable the service on **开发者中心后台 > 游戏服务 > 开发与构建 > 合规认证**. You can choose one of the following two options for your game:
...
If you see the “未查询到实名认证配置” error, it is because the Real-Name Verification service is not enabled. Please enable it on 开发者中心后台 > 游戏服务 > 开发与构建 > 合规认证.
