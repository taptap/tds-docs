...
<ul>
    <li>Import the <code>TapTap_Common_{sdkVersions.taptap.unity}.unitypackage</code> and <code>TapTap_AntiAddiction_{sdkVersions.taptap.unity}.unitypackage</code> and <code>TapTap_Login_{sdkVersions.taptap.unity}.unitypackage</code>unzipped from <code>TapSDK-UnityPackage.zip</code>.</li>
</ul>
...
<li>Copy <code>TapLogin_{sdkVersions.taptap.android}.aar</code> to the <code>src/main/libs</code> directory under your project</li>
</ul>
