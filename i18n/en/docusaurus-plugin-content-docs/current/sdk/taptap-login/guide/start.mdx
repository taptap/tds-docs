...
SDK will save user login data in the local cache. When your game launches, you can retrieve login data using following code. This will allow the player to enter the game without having to log in.
