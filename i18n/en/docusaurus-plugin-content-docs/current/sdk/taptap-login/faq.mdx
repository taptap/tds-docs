...
Tap Login's authorisation information will trigger an authorisation expiration and automatically clear the data when the player enters the game without opening it for 30 days (without triggering an initialisation).
