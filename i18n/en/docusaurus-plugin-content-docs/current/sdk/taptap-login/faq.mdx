...
Check that the Real Name Authentication Anti-Addiction SDK package has been imported but not initialised; if you don't need real name authentication, don't import the Real Name Authentication package into your project.
