...
Go to the Developer Center, fill in the information according to the [Material Requirements](/store/release/store-material/), and submit your game for review.
