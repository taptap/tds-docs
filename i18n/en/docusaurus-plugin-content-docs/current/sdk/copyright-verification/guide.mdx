...
You can set a price for your game by going to **Developer Center > Store > Price Settings**. For testing purposes, you can set the price to <Conditional region="cn"> ¥0.01 CNY</Conditional><Conditional region="global"> $0.50 USD</Conditional>. Once you set the price, please wait for the review process to be completed.
