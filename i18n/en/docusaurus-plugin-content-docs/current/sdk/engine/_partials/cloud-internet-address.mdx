...
Some third-party platforms (like Weixin Open Platform) may require that you provide an IP address whitelist. You can obtain the inbound and outbound IP addresses used by Cloud Engine on **<Path to="engine" /> > Your group > Settings > Inbound IP and outbound IP**.
