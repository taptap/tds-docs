...
To ensure that users can have stable access to the Billboard service, we recommend that you add your own domain to your game. See **[Binding Your Domains](/sdk/domain/guide/)** for more information on how to add your domain.
...
You will be able to **duplicate** an announcement to the current game or a different game and use it as a draft. The dimensions of an announcement cannot be duplicated. An announcement duplicated from another one will have unlimited dimensions by default.
