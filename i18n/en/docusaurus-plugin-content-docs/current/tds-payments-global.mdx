...
<CodeBlock className="json">
  {`"dependencies":{
    ...
    "com.taptap.tds.androiddependencyresolver": "https://github.com/TapTap/csharp-sdk-upm.git#Android-Dependency-Resolver.git#${sdkVersions.taptap.unity}", // Gradle dependency resolver
}`}
</CodeBlock>
