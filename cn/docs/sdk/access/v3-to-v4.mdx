...
自 2024 年 8 月 30 日 TapSDK V4 版本以及新的开发者后台页面上线。此后新开通游戏应用默认是 V4 版本应用，请配套使用 v4.3.10 及以上版本 TapSDK, 参考 [**V4 版本 TapSDK 文档**](https://developer.taptap.cn/docs/sdk/access/quickstart/)进行集成。

此前创建的应用为 V3 版本，可以继续使用 v3 版本 TapSDK，参考 [**V3 版本 TapSDK 文档**](https://developer.taptap.cn/docs/v3/sdk/start/quickstart/)进行集成。相关服务仍将可用。对于符合条件的 V3 应用想要升级使用 V4 版本 SDK，也可通过工单反馈进行申请，申请通过并升级完成后可以参考 [**V4 版本 TapSDK 文档**](https://developer.taptap.cn/docs/sdk/access/quickstart/)进行集成。
...
1. 之前未使用内建账户、云存档、排行榜、数据存储、悬浮窗、游戏好友、云引擎、多人在线对战、TapTap 好友、自定义域名、客服系统的情况下可以申请升级。
