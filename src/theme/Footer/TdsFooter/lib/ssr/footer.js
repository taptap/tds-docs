...
const Dt = {
  ...
  let A, i;
  return i = oe(ie, (r) => A = r), n.css.add(Dt), i(), `<div class="logo flex-align-center svelte-q6sm0c"><div class="logo-img svelte-q6sm0c" style="${"background-image: url(" + d(mt, !0) + ")"}"></div></div>`;
});
const ft = {
