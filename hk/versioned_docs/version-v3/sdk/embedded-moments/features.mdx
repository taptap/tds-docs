...
当玩家在内嵌动态内发布动态或者进行互动时，需要进行 TapTap 账号登录，故此开发者需要接入 **[TapTap 登录](/v3/sdk/taptap-login/features/)**。
...
为了更好帮助游戏进行活动运营，TDS 提供开发者自定义配置内嵌状态的运营位，你可以在「游戏服务」-「内嵌动态」-「运营位配置」中新增运营位，需要提供标题、图片 Banner、和链接。
