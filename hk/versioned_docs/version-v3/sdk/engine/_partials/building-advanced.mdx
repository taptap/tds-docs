...
<p>
  详细的说明见 <a href='/v3/sdk/engine/deep-dive/leanengine-yaml'>Reference: leanengine.yaml</a>
...
支持的完整列表见 [Reference: leanengine.yaml](/v3/sdk/engine/deep-dive/leanengine-yaml#systemdependencies-系统级依赖)。
