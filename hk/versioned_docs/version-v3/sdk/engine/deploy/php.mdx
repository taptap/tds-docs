...
:::info
这篇文档是针对 PHP 运行环境的深入介绍，如希望快速地开始使用云引擎，请查看 [快速开始部署云引擎应用](/v3/sdk/engine/deploy/getting-started)。
:::
...
<Conditional brand="leancloud">对于新创建的应用，</Conditional>如未设置 PHP
版本，云引擎会默认使用最新的稳定版本。
<Conditional brand="leancloud">
  在 2021-09-02 之前创建的分组因兼容考虑会默认使用 `5.6` 版本。
</Conditional>
