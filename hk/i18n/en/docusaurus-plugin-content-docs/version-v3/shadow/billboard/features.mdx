...
To ensure that users can have stable access to the Billboard service, we recommend that you add your own domain to your game. See **[Domain](/v3/sdk/domain/guide/)** for more information on how to add your domain.
