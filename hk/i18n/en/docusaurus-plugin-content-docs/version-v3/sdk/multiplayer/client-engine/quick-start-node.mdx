...
In this document, we'll first learn how to start the project locally, briefly try it out, and then deploy the project to the cloud. After that, we will introduce the detailed game logic and how to develop our own game in [Developer Guide](/v3/sdk/multiplayer/client-engine/guide-node/).

### Start the project

### Install command line tools

Please check the **[Installation section](/v3/sdk/engine/cli/#installation)** of the documentation of the command line tool to install the command line tool and execute the **[Login](/v3/sdk/engine/cli/#login-account)** command to log in.
...
Log in to the LeanCloud console in a browser, bind a [Cloud Engine domain](/v3/sdk/domain/guide/#cloud-engine-domain) (custom domains starting with `stg-` will be automatically bound to the staging environment), and then visit the corresponding URL to see the text indicating that the Client Engine server is running.

For other detailed deployment methods, please refer to [Deployment](/v3/sdk/engine/cli/#deployment) in the command line tools documentation.

## Your first Client Engine game

Next, please see the documentation [Your First Client Engine Game](/v3/sdk/multiplayer/client-engine/first-game-node/) for a step-by-step guide on how to develop a rock-paper-scissors game based on this initial project.
