...
This demo is implemented with [Multiplayer](/v3/sdk/multiplayer/features/) and [Client Engine](/v3/sdk/multiplayer/client-engine/). The language used is JavaScript. It took about 7 days to implement all server-side and client-side code. The main features are: quick start, character attribute setting, in-room battle, etc. For details, please click [project link](https://github.com/leancloud/multiplayer-turn-based-game-demo).

### Real-time battle demo

This demo is a streamlined version of the game "Ball Battle" made with [Multiplayer](/v3/sdk/multiplayer/features/), Cocos Creator (JavaScript), and Unity (C#). It took about 8 days to build the project. The demo mainly demonstrates the logic related to mobile synchronization.
...
LeanCloud Anniversary Game is a WeChat game where players can score points by clicking on falling cakes, and the highest scorers can win prizes. The server side mainly uses [Cloud Engine](/v3/sdk/engine/overview/) and [Leaderboard](/v3/sdk/leaderboard/features/). For details, please click [project link](https://github.com/leancloud/LeanCloudBirthday).
