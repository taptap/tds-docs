...
After you integrate the copyright verification SDK into your game, the SDK will make a verification query on purchase results when a user launches the game. The user will be able to access the game if it has been purchased normally. Otherwise, a message will remind the player to purchase the game first. Refer to [Developer Guide](/v3/sdk/copyright-verification/guide/) for details about the integration.
