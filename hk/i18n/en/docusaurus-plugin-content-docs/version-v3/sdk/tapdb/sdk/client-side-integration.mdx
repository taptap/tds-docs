...
dependencies {
    // ...
    implementation (name:'TapBootstrap_${v3SDKVersions.taptap.android}', ext:'aar')  // Required: TapSDK Launcher
    ...
    implementation (name:'TapDB_${v3SDKVersions.taptap.android}', ext:'aar') //Statistics
}`}
</CodeBlock>
</>
...
advertiserIDCollectionEnabled | No | IDFA switch, please refer to the [Collect Device Fingerprint](/v3/sdk/tapdb/sdk/client-side-integration#idfaios) documentation.
...
dbConfig.advertiserIDCollectionEnabled=YES; // IDFA switch, please refer to the [Collect Device Fingerprint](/v3/sdk/tapdb/sdk/client-side-integration#idfaios) documentation.
...
**Tips:It is recommended to use the server-side recharge statistics interface under conditions that permit it. Please refer to the [server-side integration documentation](/v3/sdk/tapdb/sdk/server-side-integration#充值记录).**
