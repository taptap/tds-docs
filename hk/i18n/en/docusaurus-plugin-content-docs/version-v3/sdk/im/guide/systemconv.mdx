...
In the previous chapter, [Security, Chat Rooms, and Temporary Conversations](/v3/sdk/im/guide/senior/), we introduced our third-party signing mechanism. In this chapter, we will cover the following functionalities offered by the Instant Messaging service:
...
For a rich media message, the `content` parameter will be a string containing a JSON object. See [Instant Messaging REST API Guide](/v3/sdk/im/guide/rest/) for more information about the structure of this object.
...
A system conversation is also a kind of conversation. When a system conversation is created, an entry will be added to the `_Conversation` table with `sys` being `true`. See [Instant Messaging REST API Guide](/v3/sdk/im/guide/rest/) for more information on how to create a system conversation.

### Sending Messages to System Conversations

[Instant Messaging REST API Guide](/v3/sdk/im/guide/rest/) contains detailed instructions on how to send messages to users through system conversations. Besides this, users can send messages to system conversations in the same way they send messages to basic conversations.
...
Besides what’s mentioned above, a broadcast message will be treated in the same way as a basic message. See [Instant Messaging REST API Guide](/v3/sdk/im/guide/rest/) for more information on how to send broadcast messages.

### Getting History Messages of System Conversations

To obtain the messages sent to users through system conversations, see [Instant Messaging REST API Guide](/v3/sdk/im/guide/rest/).
...
- [Overview](/v3/sdk/im/guide/overview/)
- Chapter 1: [Basic Conversations and Messages](/v3/sdk/im/guide/beginner/)
- Chapter 2: [Advanced Messaging Features, Push Notifications, Synchronization, and Multi-Device Sign-on](/v3/sdk/im/guide/intermediate/)
- Chapter 3: [Security, Chat Rooms, and Temporary Conversations](/v3/sdk/im/guide/senior/)
