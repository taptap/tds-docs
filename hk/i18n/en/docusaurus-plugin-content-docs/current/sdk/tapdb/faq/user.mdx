...
A: The subcontracting channel is the information in the channel field when the data is reported, which is convenient for you to split the data. See [TapSDK initialization](/v3/sdk/tapdb/sdk/client-side-integration#tapsdk-init) for details on how to connect.
