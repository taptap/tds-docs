...
<>
  配置完成以后就可以在 <strong>Window &gt; Package Manager &gt; My Registries</strong> 中安装 <strong>TapTap Payments Global V2 （{v3SDKVersions.tapGlobalPayments.unity}）</strong>。
...
<CodeBlock className="json">
  {` "dependencies": {
    "com.taptap.tds.payments.global.v2": "${v3SDKVersions.tapGlobalPayments.unity}", //添加 TapPayment
