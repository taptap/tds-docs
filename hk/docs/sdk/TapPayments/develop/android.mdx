...
<CodeBlock className="java">
 {`dependencies {
    ...
    implementation 'com.taptap.android.payment:iap:${v3SDKVersions.tapGlobalPayments.android}'
    implementation 'com.taptap.android.payment:base:${v3SDKVersions.tapGlobalPayments.android}'
    implementation 'com.taptap.android.payment:stripe:${v3SDKVersions.tapGlobalPayments.android}'
    implementation 'com.taptap.android.payment:braintree:${v3SDKVersions.tapGlobalPayments.android}'
    implementation 'com.taptap.android.payment:alipay:${v3SDKVersions.tapGlobalPayments.android}'
}
`}
</CodeBlock>
