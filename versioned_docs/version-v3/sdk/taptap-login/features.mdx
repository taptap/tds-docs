...
请确认已经在 **TapTap 开发者中心 > 应用配置** 完成了开启操作。可参照入门指南中的[准备工作](/v3/sdk/start/get-ready/)。
...
- 使用内建账户方式，参考[检查登录状态](/v3/sdk/taptap-login/guide/start/#检查登录状态)。
- 使用单纯 TapTap 登录，参考[检查登录状态和用户信息](/v3/sdk/taptap-login/guide/tap-login/#检查登录状态和用户信息)。
