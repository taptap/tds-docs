...
:::info
中国大陆节点的云引擎应用会默认启用加速节点，如果确实需要准确的原始请求 IP，可以开通独立 IP 来绕过加速节点，更多关于加速节点与独立 IP 的区别见 [域名绑定指南 § 云引擎域名](/v3/sdk/domain/guide/#云引擎域名)。
:::
...
:::caution
在使用加速节点的情况下，「强制 HTTPS」选项无法正确工作，仍需 [在项目代码层面实现重定向](/v3/sdk/engine/functions/sdk/#如何使用-sdk-重定向到-https)。
:::
...
:::info
如果希望完全避免被缓存机制影响，可以开通独立 IP 来绕过加速节点，更多关于加速节点与独立 IP 的区别见 [域名绑定指南 § 云引擎域名](/v3/sdk/domain/guide/#云引擎域名)。
:::
