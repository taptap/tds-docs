...
**[云引擎](https://developer.taptap.cn/docs/sdk/engine/overview/)** 提供给开发者自定义云端逻辑的接口，例如开发者想记录每一个用户登录系统的时间，打印一下日志，以备之后的查询和分析，那么云引擎提供的接口就可以实现这一需求，详细的操作请查看 **[云函数和 Hook](/v3/sdk/engine/functions/getting-started/)** 文档。
