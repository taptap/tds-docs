...
title: 即时通讯文本检测
sidebar_label: 文本检测
slug: /sdk/im/best-practice/hook-text-moderation
---
...
1. [详解消息 hook 与系统对话](/v3/sdk/im/guide/systemconv/)
2. [云函数和 Hook 开发指南 § 在线编写云函数](/v3/sdk/engine/functions/guides#在线编写云函数)
...
涉及到的即时通讯 hook 参数和文本检测服务请求与响应参数，请参考[即时通讯 \_messageReceived Hook](/v3/sdk/im/guide/systemconv/#_messagereceived)和第三方文本检测服务的 API 文档。
