...
TapTap 登录依赖于初始化模块，使用本地文件方式添加依赖时，需先参考 [TapSDK 集成](/v4/sdk/access/quickstart/#本地文件依赖) 添加对应本地文件依赖项。
...
TapTap 登录模块依赖于 TapTapSDK 初始化，具体参考 [TapSDK 集成](/v4/sdk/access/quickstart/#初始化)
