...
`dependencies {
    implementation 'com.taptap.sdk:tap-core:${sdkVersions.taptap.android}'
    implementation 'com.taptap.sdk:tap-kit:${sdkVersions.taptap.android}'
    implementation 'com.taptap.sdk:tap-login:${sdkVersions.taptap.android}'
}`
}</CodeBlock>
...
<CodeBlock>{` pod 'TapTapLoginSDK', '~> ${sdkVersions.taptap.ios }'`}</CodeBlock>
