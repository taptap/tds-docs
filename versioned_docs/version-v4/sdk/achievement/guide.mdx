...
dependencies {
    ...
    implementation 'com.taptap.sdk:taptap-arhievement:latest'
}
```
</>
...
1. 在工程 Podfile 文件中对应模块下添加依赖：` pod 'TapTapAchievementSDK', '~> 4.3.0'
   `
...
TapTapAchievement.registerCallback(
    callback = object : TapAchievementCallback {
...
class GameMainSence: NSObject, TapTapAcheievementCallback {
...
TapTapAchievement.setToastEnable(
    enable = true
)
```
