...
dependencies {
    ...
    implmentation 'com.taptap.sdk:taptap-arhievement:latest'
}
```
</>
...
成就模块依赖于 Tap 登录模块，使用本地文件方式添加依赖时，需先参考 [入门指南](/v4/sdk/start/quickstart#本地文件依赖)  和 [TapTap 登录](/v4/sdk/taptap-login/guide/#本地文件依赖) 添加对应本地文件依赖项。
