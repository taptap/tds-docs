...
`dependencies {
    ...
    implementation 'com.taptap.sdk:tap-login:${sdkVersions.taptap.android}' // 登录
    implementation 'com.taptap.sdk:tap-moment:${sdkVersions.taptap.android}' // 内嵌动态
}`
}
...
<CodeBlock>{` pod 'TapTapCoreSDK', '~> ${sdkVersions.taptap.ios }'`}</CodeBlock>
