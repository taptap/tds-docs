...
## 创建应用
请登录 [TapTap 开发者中心](https://developer.taptap.cn/) 注册为开发者并创建应用。

## 下载 TapTap 应用
点击下载 [TapTap 应用](https://www.taptap.cn/mobile)
...
1. **File > Build Settings** 添加 Android 配置文件。
   ...
   ![](https://img.tapimg.com/market/images/b00843d16d7a2ae2974ae69e3a7cae55.png)
