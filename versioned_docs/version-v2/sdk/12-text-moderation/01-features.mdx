...
提供便捷灵活的 API 接入方式，详细 API 参考 [开发指南](/v2/sdk/text-moderation/guide) 
...
在该页可对场景进行策略配置，包括启用的识别类型、使用的词库。此处可获取场景 ID ，用于 API 请求时指定场景进行检测，场景参数详见 [开发指南](/v2/sdk/text-moderation/guide)
...
详细 API 使用见 [开发指南](/v2/sdk/text-moderation/guide)
