...
通过 SDK 调用云函数时，SDK 会根据当前环境设置 `X-LC-Prod` HTTP 头，详见[云函数指南](/v2/sdk/engine/guide/cloudfunction)中《切换云引擎环境》一节的说明。
...
你还可以阅读[云函数指南](/v2/sdk/engine/guide/cloudfunction)来获取更多的信息。
