...
- **[正版验证](/v2/sdk/copyright-verification/guide)**：帮助开发者验证玩家设备中的付费游戏是否通过 TapTap 商店付费购买下载，有效地控制了未付费玩家从其他途径获得游戏的场景。
...
使用对应的服务请先完成[开发者注册](https://developer.taptap.com)，之后登录开发者中心开启「游戏服务」。