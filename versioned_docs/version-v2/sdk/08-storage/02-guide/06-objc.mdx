...
请阅读[数据存储、即时通讯 Objective C SDK 配置指南](/v2/sdk/storage/guide/setup-objc)。
...
全文搜索是一个针对应用数据进行全局搜索的接口，它基于搜索引擎构建，提供更强大的搜索功能。要深入了解其用法和阅读示例代码，请阅读[全文搜索指南](/v2/sdk/storage/guide/fulltext-search)。
