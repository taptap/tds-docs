...
```xml
<dependency org="cn.leancloud" name="realtime-core" rev="8.0.1" />
```

SBT:

```scala
libraryDependencies += "cn.leancloud" %% "realtime-core" % "8.0.1"
```
...
模板项目和[云引擎网站托管指南](/v2/sdk/engine/guide/webhosting)中的示例代码均未配置 API 自定义域名，
