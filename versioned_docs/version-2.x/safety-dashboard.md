...
在该页可对场景进行策略配置，包括启用的识别类型、使用的词库。此处可获取场景 ID ，用于 API 请求时指定场景进行检测，场景参数详见 [API 文档](/2.x/sdk/text-moderation/guide)
...
详细 API 使用见 [API 文档](/2.x/sdk/text-moderation/guide)
