...
rm -rf tmp/zh-Hans/storage/fulltext-search tmp/zh-Hans/storage/features.mdx tmp/zh-Hans/storage/rest.mdx
rm -rf tmp/en/storage/fulltext-search tmp/en/storage/features.mdx tmp/en/storage/rest.mdx
