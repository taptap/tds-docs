---
title: 应用间数据共享
slug: /sdk/storage/guide/app-data-share/
sidebar_position: 4
---
...
选中一个想要绑定到其他应用数据的 Class，点击「权限」一栏，可以看到 Class 绑定菜单的按钮，点击即可进入：

![class binding](/img/storage/class-binding.png)
...
每个 Class 只能触发**其所属应用**的 [hook 函数](/sdk/engine/functions/guides/#数据存储-hook)，不会触发所绑定的应用的 hook。
