...
rm -rf docs/ad-apply docs/community docs/sdk/anti-addiction docs/sdk/domain docs/sdk/embedded-moments/bestpractice.mdx docs/sdk/embedded-moments/features.mdx docs/sdk/engine/dedicated-IP.mdx docs/sdk/fire-test docs/sdk/multiplayer docs/sdk/push/guide/android-mixpush.mdx docs/sdk/start/agreement.mdx docs/sdk/tap-canary docs/sdk/tap-friend docs/sdk/tap-play docs/sdk/taplink docs/sdk/taptap-login/guide/upgrade1.x.mdx docs/sdk/taptap-login/guide/upgrade2.x.mdx docs/store
