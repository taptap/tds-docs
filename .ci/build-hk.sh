...
rm -rf docs/community docs/sdk/anti-addiction docs/sdk/domain docs/sdk/engine/dedicated-IP.mdx docs/sdk/push/guide/android-mixpush.mdx docs/sdk/start/agreement.mdx docs/sdk/tap-canary docs/sdk/tap-play docs/sdk/taptap-login/guide/upgrade1.x.mdx docs/sdk/taptap-login/guide/upgrade2.x.mdx docs/store
