...
rm -rf docs/community docs/sdk/achievement docs/sdk/anti-addiction docs/sdk/domain docs/sdk/engine/dedicated-IP.md docs/sdk/tap-canary docs/sdk/tap-play docs/sdk/taptap-login/guide/upgrade1.x.md docs/sdk/taptap-login/guide/upgrade2.x.md docs/store
