...
implementation 'com.taptap.android.payment:sdk:1.0.9'
```
...
```java
implementation("com.taptap.android:login:3.29.0@aar")
implementation("com.taptap.android:common:3.29.0@aar")
```
:::
