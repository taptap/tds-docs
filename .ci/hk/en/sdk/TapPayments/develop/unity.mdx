...
- 参照 [准备工作](/docs/sdk/start/get-ready/) 所述创建 app，配置 app 参数并且绑定 API 域名
- 参照 [TapSDK 快速开始](/docs/sdk/start/quickstart/) 配置包名和签名
...
![](/img/io/tapPayments/NdoQbmRRvovet4x3LGUcsTXWnjb.png)
...
![](/img/io/tapPayments/ZLXNblCW8oDEJ9xIyrLcNB2onLd.png)

配置完成以后就可以在 **Window > Package Manager** 中安装 TapTap Payments Global V2。

![](/img/io/tapPayments/GEmKbF8jLoT5SBxqNMAcAmtMnWb.png)
...
![](/img/io/tapPayments/VrHVbfdKUoCHgXxmOYkccZLMn8e.png)
...
![](/img/io/tapPayments/TFgMbu4JhohID1xHBnhcet7nnth.png)
