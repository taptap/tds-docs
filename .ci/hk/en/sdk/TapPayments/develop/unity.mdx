...
<>
  配置完成以后就可以在 <strong>Window &gt; Package Manager &gt; My Registries</strong> 中安装 <strong>TapTap Payments Global V2 （{sdkVersions.tapGlobalPayments.unity}）</strong>。
  如果安装目录中没有 <code>TapTap Payments Global V2</code>, 请尝试在 <strong>Edit &gt; Project Settings &gt; Package Manager</strong> 中重新注册 NPMJS。
</>

![](https://img.tapimg.com/market/images/99016df3ebcad95f3e2cde649f023619.png)
