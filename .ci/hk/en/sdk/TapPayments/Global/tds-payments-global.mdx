...
The only scenarios where the game server should use the REST API are the `Query Order` and `Verify Order` APIs, and an example of an exception response is shown below:
