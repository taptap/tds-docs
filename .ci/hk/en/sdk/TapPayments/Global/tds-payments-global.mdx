...
2. In the Unity project, go to **Assets > Import Packages > Custom Packages** and select the TapSDK packages you want to use in your game from the unzipped `TapSDK-UnityPackage.zip`, where:
   ...
   - `TapTap_Android_Dependency_Resolver.unitypackage` [Click to download](https://github.com/taptap/android_dependency_resolver/releases) TapTap Android Dependency Resolver (required for Android).
