...
- Prepare and configure the interface addresses for [Webhook](/sdk/TapPayments/Global/tds-tappay-server-api/#webhook-callback), [Role Information](/sdk/TapPayments/Global/tds-tappay-server-api/#role-information), and [Purchase Configuration](/sdk/TapPayments/Global/tds-tappay-server-api/#purchase-onfiguration-api) (optional).
