...
![](/img/operations-manual/Operations-ManualCH-02.png)
...
![](/img/operations-manual/Operations-ManualCH-03.png)

![](/img/operations-manual/Operations-ManualCH-04.png)

![](/img/operations-manual/Operations-ManualCH-05.png)
...
![](/img/operations-manual/Operations-ManualCH-06.png)

Once posted, players will receive a push for “Article” in the Notifications column.

![](/img/operations-manual/Operations-ManualCH-07.png)
...
![](/img/operations-manual/Operations-ManualCH-10.png)
...
![](/img/operations-manual/Operations-ManualCH-11.png)

## Introduction to editing resources

### Home page content recommendations

If you have high-quality gaming content, such as the latest version of new games, game-related interviews, and great game highlights. You can send emails to overseas editors through **<DevService@taptap.com>** to apply for referrals to pursue greater exposure on the home page and upcoming.
...
If there are major events related to the launch and update of the game, you can fill in **[sheet](<https://developer.taptap.com/docs/files/Name_TapTap%20ID_Roadmap(2).xlsx>)** and submit the corresponding materials so that we can promote them. Please make sure to sync them to us by attaching it in the email about one week before the launch and update.

![](/img/operations-manual/Operations-ManualCH-12.png)
...
If your work has a lot of content worth sharing with players, you can send emails to overseas editors through <DevService@taptap.com> to communicate with us, and let us attract more users through the content together.

![](/img/operations-manual/Operations-ManualCH-13.png)
...
![](/img/operations-manual/Operations-ManualCH-14.png)

Twitter:

![](/img/operations-manual/Operations-ManualCH-15.png)

Youtube:

![](/img/operations-manual/Operations-ManualCH-16.png)

Discord:

![](/img/operations-manual/Operations-ManualCH-17.png)
