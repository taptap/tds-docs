...
1. 需要依次进入 **TapTap 开发者中心 > 你的游戏 > 游戏服务 > TapPayment > 商品与订单 > API 密钥**，检查是否有已生效的秘钥，没有则需要 **添加新的秘钥**
...
public class SignatureExample {
    ...
    public static void main(String[] args) {
        try {
            String secret = "6n8cdaz6Qq5pYjNaQ88BzWkVvNATeOhY";
            String body = "{\"name\":\"test\"}";
            URI uri = new URI("https://example.com/my-service/v1/my-method?client_id=XXX&some_param=123&another=456");

            HttpRequest.Builder requestBuilder = HttpRequest.newBuilder()
                .uri(uri)
                .header("Content-Type", "application/json")
                .header("Authorization", "Bearer ourSenEFQhvkC4Mww6uk8fs0d28eFrvzaH59ORp1")
                .header("X-Tap-Ts", "1711296000")
                .header("X-Tap-Nonce", "XphYC2P1cl")
                .header("X-Tap-Sign", "Z9i6Az32ZpDzAvPhHX22+KCNoBW0CishEAXDiVxfA18=")
                .header("X-Tap-0", "1")
                .header("X-Tap-00", "2")
                .header("X-Tap-A00", "3");
