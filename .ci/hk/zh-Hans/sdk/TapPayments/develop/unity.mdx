...
可以通过两种方式添加相关依赖: 1.Package Manager 可视化界面操作, 2.修改 Packages/manifest.json 引入依赖。
两种方式均可以，任选其中一种进行操作

### 1. Package Manager 可视化界面操作
...
![](https://capacity-files.lcfile.com/k8MtkgoHCnAyfz72nbukYuOaIModYMNV/npmjs.png)
...
{
  "dependencies": {
    "com.taptap.tds.payments.global.v2": "1.0.3", //添加 TapPayment 
