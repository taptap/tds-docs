...
配置完成以后就可以在 **Window > Package Manager > My Registries** 中安装 **TapTap Payments Global V2 （1.0.4)**
如果安装目录中没有 `TapTap Payments Global V2`, 请尝试在 **Edit > Project Settings > Package Manager** 中重新注册 NPMJS

![](https://lc-buhezimj.cn-e1.lcfile.com/wA1H9pQEVCx4VVkyxgneYrHwAFc4tQU2/version.png)
...
{
  "dependencies": {
    "com.taptap.tds.payments.global.v2": "1.0.9", //添加 TapPayment 
    "com.unity.purchasing": "3.1.0", //TapPayment 所须依赖
    "com.google.external-dependency-manager": "1.2.179", //TapPayment 所须依赖
    "com.taptap.tds.common":"3.29.0",
    "com.taptap.tds.login":"3.29.0",
    ...
    ...
  },
