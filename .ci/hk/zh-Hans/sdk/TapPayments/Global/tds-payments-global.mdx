...
|/open/payment/v1/orders/&lt;order_id&gt;/unconfirmed|GET     | 查询未核销的订单列表               |
...
curl -X POST \
  -H 'X-LC-Id: {{client_id}} \
  -H 'X-LC-Key: {{server_secret}},master \
  https://tds-tapsdk0.intl.tapapis.com/open/payment/v1/orders/1670731970469806082/verify?token=2cf31318c6f4939d5eaf2e9431bf45f2
```
返回值是一个订单的 JSON 对象
