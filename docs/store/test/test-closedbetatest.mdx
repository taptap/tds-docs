...
如果您的测试需要用户进入游戏抢注测试账号或完成创角后才可获得测试资格，您可在设置先到先得时勾选“用户抢注游戏账号后获取测试资格”。此时，用户参与测试时将收到通知，提示其尽快抢注游戏账号。
![](https://img.tapimg.com/market/images/337276069daf426e2d51dfb21689aa73.png)
