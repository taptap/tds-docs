...
TapPay-Global 是一项可让您在游戏中销售虚拟商品的服务。

您可以在 TapPay-Global 中销售以下类型的商品：
...
借助 TapTap 开发者中心，可以方便地创建游戏内商品，并且在游戏中便捷地接入 TapPay-Global 的服务，来进行游戏商品的销售。
