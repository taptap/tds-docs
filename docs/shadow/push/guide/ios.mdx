...
本文介绍了如何在 iOS 设备中使用推送通知功能。建议先阅读[推送通知总览](/shadow/push/guide/overview/)了解相关概念。

## 配置 APNs 推送证书

配置 APNs 证书是使用推送服务的前提，详情请参考[iOS 推送设置指南](/shadow/push/guide/ios-cert/)。
...
更多可用的保留字段，请参考[推送 REST API 使用指南](/shadow/push/guide/rest/)的《消息内容参数》一节。
