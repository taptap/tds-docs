...
<table>
  ...
  <tbody>
    <tr>
      <th style={{whiteSpace: "nowrap"}}>起一个好标题</th>
      <td>标题是活动发布前需要处理的重中之重，良好的标题设计，可以快速吸引玩家眼球标题的设计可以从版本热点、奖品噱头、参与方式等方面进行入手。</td>
    </tr>
    <tr>
      <th style={{whiteSpace: "nowrap"}}>设计参与方式</th>
    ...
    <tr>
      <th style={{whiteSpace: "nowrap"}}>避免无价值内容</th>
...
<table>
  ...
  <tbody>
    <tr>
      <th rowSpan="3" style={{whiteSpace: "nowrap"}}>发帖参与</th>
      <td rowSpan="3">
        <p>发帖可分为图文、纯文字、视频；</p>
        <p>
    ...
    <tr>
      <th rowSpan="3" style={{whiteSpace: "nowrap"}}>回帖参与</th>
      <td rowSpan="3">
        <p>回帖可分为图片、图文、视频；</p>
        <p>
    ...
    <tr>
      <th rowSpan="3" style={{whiteSpace: "nowrap"}}>互动参与</th>
      <td rowSpan="3">
        <p>玩家点赞或转发，参与更简单；</p>
        <p>
