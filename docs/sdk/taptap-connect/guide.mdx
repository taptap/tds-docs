...
githubDeps={[
    ...
    {package: "com.taptap.tds.connect", url: `https://github.com/TapTap/TapConnect-Unity.git#${sdkVersions.taptap.unity}`},
    {package: "com.taptap.tds.moment", url: `https://github.com/TapTap/TapMoment-Unity.git#${sdkVersions.taptap.unity}`},
    {package: "com.leancloud.realtime", url: `https://github.com/leancloud/csharp-sdk-upm.git#realtime-${sdkVersions.leancloud.csharp}`},
    {package: "com.taptap.tds.login", url: `https://github.com/leancloud/csharp-sdk-upm.git#storage-${sdkVersions.leancloud.csharp}`},
]}
unitypackageModules={[
