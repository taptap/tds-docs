...
1. [即时通讯总览](/sdk/im/guide/overview/)。
2. [Android 混合推送开发指南](/shadow/push/guide/android-mixpush/) / [iOS 推送开发指南](/shadow/push/guide/ios/)。
</Conditional>
...
1. 静态配置提醒消息
   ...
   <Conditional brand="tds">
   此外，对于 iOS 设备您还可以设置声音等推送属性，具体的字段可以参考 [推送 REST API 使用指南](/shadow/push/guide/rest/) 的《消息内容参数》一节。
   </Conditional>
...
- 《即时通讯开发指南》第三篇[安全与签名、玩转聊天室和临时对话](/sdk/im/guide/senior/)
