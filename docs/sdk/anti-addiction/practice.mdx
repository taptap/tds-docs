...
public class GameMainScene : MonoBehaviour
{
    ...
    private Action<int, string> AntiAddictionCallback => (code, extra) =>
    {
        ...
        switch (code)
        {
            ...
            case 1000: // 退出账号，当调用 AntiAddictionUIKit.Exit() 接口时触发      
            case 1001: // 玩家在实名认证过程中，点击了「切换账号」按钮 
                // TODO: 退出账号，重新登录
                break;


            case 1100: // 当前玩家触发游戏设置的适龄限制      
                // TODO: 弹出游戏绘制的适龄限制提示，并引导玩家退出游戏
                break;
