...
According to laws and regulations and the requirements of relevant departments, the use of cloud services needs to bind a domain name that has been filed with the Ministry of Industry and Information Technology. Binding your own domain name is also conducive to good application isolation from the domain name level to ensure business stability.
