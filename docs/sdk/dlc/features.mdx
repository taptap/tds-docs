...
当游戏正式上线后，DLC 便开始售卖。为了维护玩家的体验，TapTap 给玩家提供了可以退款的功能。你可以在 <Conditional region="cn">[TapTap 开发者中心](https://developer.taptap.cn/)</Conditional><Conditional region="global">[TapTap 开发者中心](https://developer.taptap.io/)</Conditional> 的概览中，查看 DLC 的售卖情况，包括订单数量、售卖金额、退款订单与金额等数据。
