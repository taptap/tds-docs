...
before_script:
  ...
  - curl -L -o /bin/${CLI_BINARY} http://releases.leanapp.cn/leancloud/lean-cli/releases/download/v1.2.0/${CLI_BINARY}-linux-x64
  ...
  deploy-preview-environment:
    ...
    steps:
      ...
      - name: Install lean-cli
        run: |
          sudo curl -L -o /bin/${CLI_BINARY} http://releases.leanapp.cn/leancloud/lean-cli/releases/download/v1.2.0/${CLI_BINARY}-linux-x64
