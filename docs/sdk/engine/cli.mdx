...
<OfficeDoc fileUrl="https://capacity-files.lcfile.com/IWdfnWDnvLcrkjpcON1Yz6sSs5vFgygG/gg.pptx" />
...
before_script:
  ...
  - curl -L -o /bin/${CLI_BINARY} https://github.com/leancloud/lean-cli/releases/download/v1.2.3/${CLI_BINARY}-linux-x64
  - chmod +x /bin/${CLI_BINARY}
  - ${CLI_BINARY} login --region $REGION --token $ACCESS_TOKEN
  - ${CLI_BINARY} switch --region $REGION --group $GROUP $APP_ID\n
deploy_preview:
  stage: deploy
  script:
  ...
  deploy-preview-environment:
    ...
    steps:
      ...
      - name: Install lean-cli
        run: |
          sudo curl -L -o /bin/${CLI_BINARY} https://github.com/leancloud/lean-cli/releases/download/v1.2.3/${CLI_BINARY}-linux-x64
