...
<iframe src="https://onedrive.live.com/embed?resid=6CD1A992A9AAAB1%21138&amp;authkey=!AJsEcJOaSJUgBG0&amp;em=2&amp;wdAr=1.7770833333333333" width="100%" height="600px" frameborder="0">这是嵌入 <a target="_blank" href="https://office.com">Microsoft Office</a> 演示文稿，由 <a target="_blank" href="https://office.com/webapps">Office</a> 提供支持。</iframe>

前往 <Conditional brand='tds'>**开发者中心 > 你的游戏 > 游戏服务 > 应用配置 > 域名配置**</Conditional><Conditional brand='leancloud'>**云服务控制台 > 账号设置 > 独立 IP**</Conditional> 可以查看、管理当前账号使用的云引擎独立 IP。
