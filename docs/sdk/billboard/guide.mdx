...
| `X-LC-Sign` | `{{appSign}}` | 将 timestamp 加上 `App Key`（即当前应用的 `Client Token`）组成的字符串，再对它做 MD5 签名后的结果。| 可在控制台查看 |
...
| `dimension_list`  | 必须 | [{"维度参数"："维度字段参数"},...] ，示例：[{"platform":"ios"},{"location":"CN"}]｜
...
```json
{
    ...
    "data": {
        ...
        "lastest": {
            "id": 19,
            "content": "[{\"type\":\"image\",\"info\":{\"img_url\":\"https://tds-billboard.tds1.tapfiles.cn/20220722/28IdyXLZUMkrqcUsH6NVLf5RQzBSLrfZ.png\"}},{\"type\":\"paragraph\",\"children\":[{\"text\":\"看到标题，肯定有团长会问了：\"},{\"text\":\"说好的三月底四月初测试呢？\",\"highlight\":true},{\"text\":\"怎么那么晚才开测！\"}]},{\"type\":\"block-link\",\"info\":{\"url\":\"https://www.baidu.com/\",\"type\":\"link\",\"noLinkTitle\":false},\"children\":[{\"text\":\"点击前往测试报名\"}]},{\"type\":\"paragraph\",\"children\":[{\"text\":\"看到标题，肯定有团长会问了：说好的三月底四月z初测试呢？怎么那么晚才开测！\"}]},{\"type\":\"horizontal-rule\"},{\"type\":\"paragraph\",\"children\":[{\"text\":\"〓资格发放时间〓\"}]},{\"type\":\"paragraph\",\"children\":[{\"text\":\"·2022年4月9日 \"}]},{\"type\":\"paragraph\",\"children\":[{\"text\":\"\"}]},{\"type\":\"paragraph\",\"children\":[{\"text\":\"〓注意事项〓\"}]},{\"type\":\"paragraph\",\"children\":[{\"text\":\"·团长们填写招募问卷的TapTap ID即测试授权的登录账号；\"}]},{\"type\":\"paragraph\",\"children\":[{\"text\":\"·4月14日开测当天官方还会再次给拥有测试资格的团长发送通知，届时请留意手机短信、站内信。官方资讯将有详细开测指引；\"}]}]",
            "short_title": "公告跳转链接地址",
...
| `close_button_img`  | 在导航接口中获取关闭按钮url｜
