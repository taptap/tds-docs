...
<CodeBlock className="xml">
  {`<dependency org="com.taptap" name="lc-storage-core" rev="${sdkVersions.leancloud.java}" />`}
</CodeBlock>
...
<CodeBlock className="scala">
  {`libraryDependencies += "com.taptap" %% "lc-storage-core" % "${sdkVersions.leancloud.java}"`}
</CodeBlock>
...
<CodeBlock className="groovy">
  {`implementation 'com.taptap:lc-storage-core:${sdkVersions.leancloud.java}'`}
</CodeBlock>
