...
<Conditional brand="leancloud">开发版</Conditional><Conditional brand="tds">[标准版](https://developer.taptap.com/product-intro/price)</Conditional>提供每天 API 读写请求**三万次**的免费额度。
