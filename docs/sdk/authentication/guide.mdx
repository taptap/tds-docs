...
FTDSUser::BecomeWithSessionToken("anmlwi96s381m6ca7o7266pzf", OnSuccess, OnError);
```
...
FTDSUser::LoginWithAuthData("lc_apple", AppleAuthData, OnSuccess, OnError);
```
...
UserPtr->AssociateWithAuthData("weixin", AuthData, OnSuccess, OnError);
```
...
UserPtr->DisassociateAuthData("weixin", OnSuccess, OnError);
```
