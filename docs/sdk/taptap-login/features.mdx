...
[点击此处](https://www.taptap.cn/mobile) 下载 TapTap 移动客户端。

</Conditional>

<Conditional region="global">

[点击此处](https://www.taptap.io/mobile) 下载 TapTap 移动客户端。
...
<img src={useBaseUrl("https://capacity-files.lcfile.com/GjJAgpxX6YaTX1y20GDMQoHkc5S2SDNk/login-taptapclient.png")} alt="" width="800" />

</Conditional>

<Conditional region="global">

<img src={useBaseUrl("https://capacity-files.lcfile.com/1HXf2FOwftN0lSBi0eirDzeP36l3TIBa/login-taptapclient.png")} alt="" width="800" />
...
<img src={useBaseUrl("https://capacity-files.lcfile.com/yYR92sAScKIW0E1zftzzLWiGutJY32c9/login-webview.png")} alt="" width="800" />
