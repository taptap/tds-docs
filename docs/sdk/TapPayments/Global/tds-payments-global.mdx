...
<CodeBlock className="json">
  {`"dependencies":{
    ...
    "com.tapsdk.androiddependencyresolver": "https://github.com/luckisnow/android_dependency_resolver.git#1.1.0", // Gradle dependency resolver
}`}
</CodeBlock>
...
关于内建账户登陆的后续的操作，请参考 [一键完成 TapTap 登录](../../../taptap-login/guide/start/#一键完成-taptap-登录)。
...
<CodeBlock className="json">
  {`"dependencies":{
    ...
    "com.taptap.tds.common":"https://github.com/TapTap/TapCommon-Unity.git#${sdkVersions.taptap.unity}", 
    "com.taptap.tds.payments.global":"https://github.com/taptap/TapPayments-Global-Unity.git#${sdkVersions.taptap.unity}",
    "com.taptap.tds.androiddependencyresolver": "https://github.com/luckisnow/android_dependency_resolver#1.1.0", // Gradle dependency resolver
}`}
</CodeBlock>
...
关于单独 TapTap 授权登陆的后续的操作，请参考 [TapTap 登录并获取登录结果](../../../taptap-login/guide/tap-login/#taptap-登录并获取登录结果)。
