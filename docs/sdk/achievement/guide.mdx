...
1. 参考 [准备工作](/v4/sdk/access/get-ready/) 创建应用、开启成就服务。
...
githubDeps={[
{package: "com.taptap.tds.login", url: `https://github.com/TapTap/TapLogin-Unity.git#${v4SDKVersions.taptap.unity}`},
{package: "com.taptap.tds.common", url: `https://github.com/TapTap/TapCommon-Unity.git#${v4SDKVersions.taptap.unity}`},
{package: "com.taptap.tds.bootstrap", url: `https://github.com/TapTap/TapBootstrap-Unity.git#${v4SDKVersions.taptap.unity}`},
{package: "com.leancloud.realtime", url: `https://github.com/leancloud/csharp-sdk-upm.git#realtime-${v4SDKVersions.leancloud.csharp}`},
{package: "com.leancloud.storage", url: `https://github.com/leancloud/csharp-sdk-upm.git#storage-${v4SDKVersions.leancloud.csharp}`},
]}
unitypackageModules={[
...
成就模块依赖于 Tap 登录模块，使用本地文件方式添加依赖时，需先参考 [入门指南](/v4/sdk/access/quickstart)  和 [TapTap 登录](/v4/sdk/taptap-login/guide) 添加对应本地文件依赖项。
...
详见 [TapTapSDK 初始化文档](/v4/sdk/access/quickstart#初始化)。

<MultiLang>
<>

`TapTapSdkOptions` 详细参数见 [入门指南#快速开始](/v4/sdk/access/quickstart/#初始化)
