...
- 在 Unity 顶部菜单中选择 **Window > Package Manager**，点击 **NuGet > Manage NuGet Packages**，在弹出的窗口中搜索 `K4os.Compression.LZ4` 和 `protobuf-net` 并安装。

  最终会在 Assets文件夹下的 packages.config 文件中自动生成如下依赖：
```xml
<?xml version="1.0" encoding="utf-8"?>
<packages>
    <package id="K4os.Compression.LZ4" version="1.1.2" manuallyInstalled="true" />
    ...
    <package id="System.Reflection.Emit" version="4.7.0" />
    <package id="System.Reflection.Emit.ILGeneration" version="4.7.0" />
    <package id="System.Reflection.Emit.Lightweight" version="4.7.0" />
