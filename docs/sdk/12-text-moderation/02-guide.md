...
text | string | 是 | 进行检测的文本内容。长度不超过4096个字节 | 文本检测助力游戏厂商识别违规非法政治内容
...
type | string | 是 | 返回识别类型：<br/> 健康: Health <br/> 广告: Adv <br/> 政治: Politics <br/>辱骂: Abuse <br/>犯罪: Crime <br/>邪教: Heresy <br/>恐怖主义: Terrorism <br/>色情: Porn <br/>赌博: Gamble <br/>违禁品: Contraband <br/>突发敏感事件: SensitiveEvent <br/>违规网站: IllegalWebsite <br/>其他: OtherViolations <br/> | Politics
