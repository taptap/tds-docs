...
目前我们暂不支持配置，开发者可以直接提交**工单**联系我们，TapTap 有专业的编辑团队为您服务。

#### 提交工单方式

进入 TapTap 开发者中心后台，点击右上角「工单」，创建工单时请选择「TDS 游戏服务」-「内嵌动态」-「其他问题」，提交您的诉求，我们会尽快给您答复。
...
若需要玩家立即退出内嵌动态回到游戏内及时响应的（如即时对战），开发者可以[自定义弹窗引导](/sdk/embedded-moments/guide/#关闭动态页面)和弹窗触发的节点。
