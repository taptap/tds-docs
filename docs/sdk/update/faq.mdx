...
### 引入 TapUpdate 模块后闪退报错：Unable to get provider com.taptap.services.update.TapUpdateFileProvider: java.lang.ClassNotFoundException: Didn't find class "com.taptap.services.update.TapUpdateFileProvider"

请将 SDK 版本升级到 AndroidX 可以参考[官方文档](https://developer.android.google.cn/jetpack/androidx/migrate?hl=zh-cn)