...
- **[悬浮窗](/sdk/taptap-connect/features/)**：提供连接 TapTap、游戏和玩家的工具。成功登录 TapTap 账号的玩家可在悬浮窗内进行浏览游戏动态、评价游戏、分享游戏下载链接等操作，来帮助游戏提升留存并带来新用户。
...
- **[公告系统](/sdk/billboard/features/)**：开发者在开发者中心发布编辑公告内容，玩家在打开游戏时可以收到公告通知。
...
- **[TapADN](/sdk/tap-adn/scheme/)**： 广告联盟，帮助开发者获取广告收益。
