...
```
报错原因是因为使用 TapSDK Unity v3.7.1 及更高版本时并没有在项目的 `Packages/manifest.json` 文件中添加 `com.leancloud.storage` 模块导致的，参考[文档](https://developer.taptap.com/docs/sdk/taptap-login/guide/tap-login/#初始化)添加即可。
