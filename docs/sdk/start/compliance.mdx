...
"dependencies":{
  ...
  // 内嵌动态
//  "com.taptap.tds.moment":"https://github.com/TapTap/TapMoment-Unity.git#3.20.0",
}
```
或者移除掉统一初始化入口（详见[文档](https://developer.taptap.cn/docs/sdk/start/quickstart/#%E5%88%9D%E5%A7%8B%E5%8C%96)），示例如下：
```
...
"dependencies":{
  ...
  // 公告系统
//  "com.taptap.tds.billboard": "https://github.com/TapTap/TapBillboard-Unity.git#3.20.0",
}
```
或者移除掉统一初始化入口（详见[文档](https://developer.taptap.cn/docs/sdk/start/quickstart/#%E5%88%9D%E5%A7%8B%E5%8C%96)），示例如下：
```
...
"dependencies":{
  ...
//  "com.taptap.tds.friends": "https://github.com/TapTap/TapFriends-Unity.git#3.20.0",
}
```
或者移除掉统一初始化入口（详见[文档](https://developer.taptap.cn/docs/sdk/start/quickstart/#%E5%88%9D%E5%A7%8B%E5%8C%96)），示例如下：
```
...
"dependencies":{
  ...
//  "com.taptap.tds.achievement": "https://github.com/TapTap/TapAchievement-Unity.git#3.20.0",
}
```
或者移除掉统一初始化入口（详见[文档](https://developer.taptap.cn/docs/sdk/start/quickstart/#%E5%88%9D%E5%A7%8B%E5%8C%96)），示例如下：
```
...
"dependencies":{
  ...
//  "com.tapsdk.antiaddiction":"https://github.com/taptap/TapAntiAddiction-Unity.git#3.20.0",
}
...
"dependencies":{
  ...
//  "com.taptap.tds.rtc":"https://github.com/TapTap/TapRTC-Unity.git#3.20.0",
}
