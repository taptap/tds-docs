...
"dependencies": {
  ...
  "com.tds.themis.themis": "https://THEMISUPM:DXY6Kze9wzECU7gbM4H1@git.xindong.com/themis/themis_sdk_upm.git?path=unity/Packages/com.tds.themis.themis"
}
```
...
```cs
TapThemis.U3d_ConfigAutoReportLogLevel(LogSeverity.LogError);
```
...
#### 内容更新
1. 修改 Themis 模块依赖
2. 删除冗余 CAID 开关接口，更新 CAID 获取接口

#### 接口变更

##### 新增接口
新增 Themis 初始化接口，该接口需在 TapDB 初始化接口之后调用

```c#
TapTap.Themis.TapThemis.InitTHEMIS();
```
#### 修改接口
替换部分接口使用
