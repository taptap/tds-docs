...
参数 | 可为空 | 说明
--- | --- | ---
<Conditional brand="leancloud">appid</Conditional> <Conditional brand="tds">clientid</Conditional> | 否 | 创建游戏时获得的<Conditional brand="leancloud">APPID</Conditional> <Conditional brand="tds">ClientID</Conditional>
channel | 是 | 分包渠道，长度不大于 256
